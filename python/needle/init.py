...
def xavier_uniform(fan_in, fan_out, shape=None, gain=1.0, **kwargs):
    ...
    return rand(fan_in, fan_out, low=-a, high=a, device=kwargs.get('device', None), dtype=kwargs.get('dtype', 'float32')) 
    ### END YOUR SOLUTION
...
def xavier_normal(fan_in, fan_out, shape=None, gain=1.0, **kwargs):
    ...
    return randn(fan_in, fan_out, std = std, device=kwargs.get('device', None), dtype=kwargs.get('dtype', 'float32'))
    ### END YOUR SOLUTION
...
def kaiming_uniform(fan_in, fan_out, shape=None, nonlinearity="relu", **kwargs):
    ...
    if shape:
        return rand(*shape, low=-bound, high=bound, device=kwargs.get('device', None), dtype=kwargs.get('dtype', 'float32'))
    else:
        return rand(fan_in, fan_out, low=-bound, high=bound, device=kwargs.get('device', None), dtype=kwargs.get('dtype', 'float32'))
    ### END YOUR SOLUTION
...
def kaiming_normal(fan_in, fan_out, shape=None, nonlinearity="relu", **kwargs):
    ...
    if shape:
        return randn(*shape, std = std, device=kwargs.get('device', None), dtype=kwargs.get('dtype', 'float32'))
    else:
        return randn(fan_in, fan_out, std = std, device=kwargs.get('device', None), dtype=kwargs.get('dtype', 'float32'))
    ### END YOUR SOLUTION
